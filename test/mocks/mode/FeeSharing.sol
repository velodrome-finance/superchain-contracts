...
contract FeeSharing is Ownable, ERC721Enumerable {
    ...
    function register(address _recipient) public onlyUnregistered returns (uint256 tokenId) {
        ...
        feeRecipient[smartContract] = NftData({tokenId: tokenId, registered: true, balanceUpdatedBlock: block.number});
    }
    ...
    function assign(uint256 _tokenId) public onlyUnregistered returns (uint256) {
        ...
        feeRecipient[smartContract] = NftData({tokenId: _tokenId, registered: true, balanceUpdatedBlock: block.number});
    ...
    function distributeFees(uint256 _tokenId, address _smartContract, uint256 _blockNumber) public payable onlyOwner {
