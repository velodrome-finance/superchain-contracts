...
import {IPoolFactory} from "src/interfaces/pools/IPoolFactory.sol";
import {IMockRouter} from "./IMockRouter.sol";
...
/// @dev MockRouter contract modified to remove Gauge, Voter and FactoryRegistry dependencies
contract MockRouter is IMockRouter, ERC2771Context {
    using SafeERC20 for IERC20;

    /// @inheritdoc IMockRouter
    ...
    constructor(address _forwarder, address _factoryRegistry, address _factory, address _voter, address _weth)
        ...
        returns (address pool)
    {
        ...
        // NOTE: Any pool factory is allowed in MockRouter
